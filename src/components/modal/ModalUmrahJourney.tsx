    ...
    1: {
        ...
        doa: [
            ...
            },
            {
                ...
                latin: "Labbaika Allahumma labbaik, labbaika laa syariika laka labbaik, innal hamda wan ni'mata laka wal mulka laa syariika lak",
                meaning:
    ...
    2: {
        ...
        doa: [
            ...
            },
            {
                ...
                latin: 'Rabbana aatina fi dunya hasanatan wa fil akhirati hasanatan wa qina adzab an-naar',
                meaning:
    ...
    3: {
        ...
        doa: [
            ...
            },
            {
                ...
                meaning: 'Ya Tuhanku, ampunilah dan rahmatilah, dan Engkau adalah Yang Maha Mulia lagi Maha Pemurah',
            },
        ],
        tips: [
        ...
        doa: [
            {
                ...
                latin: "Allahumma aj'alhu hajjan mabruuran wa dzanban maghfuuran wa sa'yan masykuuran",
                meaning: "Ya Allah, jadikanlah ini haji yang mabrur, dosa yang diampuni, dan sa'i yang diterima",
            },
            {
                arabic: 'الْحَمْدُ لِلَّهِ الَّذِي هَدَانِي لِهَذَا وَمَا كُنْتُ لِأَهْتَدِيَ لَوْلَا أَنْ هَدَانِيَ اللَّهُ',
                latin: 'Alhamdulillahil ladzi hadani li hadza wa ma kuntu li ahtadiya lau laa an hadanillah',
                meaning:
...
const ModalUmrahJourney: React.FC<ModalProps> = ({ isOpen, onClose, stepId, title }) => {
                    ...
                    >
                        <div className="max-h-[70vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white shadow-2xl">
                                    ...
                                    <div className="space-y-2">
                                        {detail.procedures.map((procedure, index) => (
                                            <div key={index} className="flex items-start space-x-2">
                                                ...
                                                <p className="text-sm leading-relaxed text-gray-700">{procedure}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                        ...
                                        {detail.doa.map((doa, index) => (
                                            <div key={index} className="rounded-lg bg-gray-50 p-4">
                                                <div className="mb-3 text-right">
                                                    <p className="font-arabic text-lg leading-relaxed text-black">{doa.arabic}</p>
                                                </div>
                                                <div className="mb-2">
                                                    <p className="text-sm leading-relaxed text-gray-700 italic">{doa.latin}</p>
                                                </div>
                                                <div>
                                                    <p className="text-xs leading-relaxed text-gray-600">
                                                        <span className="font-medium text-black">Artinya:</span> {doa.meaning}
                                                    </p>
                                                </div>
                                            </div>
                                        ))}
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {detail.tips.map((tip, index) => (
                                            <div key={index} className="flex items-start space-x-2 rounded-lg bg-blue-50 p-2">
                            ...
                            <div className="rounded-b-xl border-t border-gray-200 bg-gray-50 px-4 py-3">
                                <p className="text-center text-xs text-gray-500">Semoga Allah SWT menerima ibadah Umrah Anda</p>
                            </div>
                        </div>
                    </motion.div>
                </>
