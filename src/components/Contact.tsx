const Contact: React.FC = () => {
  return (
    <div
      className="container mx-auto px-6 py-12 md:px-10 lg:px-16"
      id="Contact"
    >
      <h1 className="mb-12 text-center text-4xl font-bold text-[#222636]">
        HUBUNGI KAMI
        <span className="mx-auto mt-2 block h-1 w-24 bg-[#222636]"></span>
      </h1>
      ...
      <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
        ...
        <div className="px-2">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
            <h2 className="mb-6 text-2xl font-semibold text-[#222636]">
              KANTOR PUSAT
            </h2>
